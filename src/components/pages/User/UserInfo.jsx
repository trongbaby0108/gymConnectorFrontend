                    ...
                    <div className='max-w-full flex flex-col justify-center items-center'>
                        <div className="grid md:grid-cols-2 md:gap-16">
                            ...
                            <div className="spacing-15">
                                <img class="w-96 h-96 rounded-full" src="https://scr.vn/wp-content/uploads/2020/07/avt-cute.jpg" alt="image description" />

                                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300" for="file_input">Đăng tải</label>
                                ...
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">Tải lên file có đuôi .PNG, .JPG.</p>
